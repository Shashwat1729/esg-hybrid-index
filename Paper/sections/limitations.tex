...
\item \textbf{One window, one cross-section.} The OOS test covers
  ...
  to other regimes. The registered second window adds a second, independent
  period; repeating the snapshot--hold-out cycle beyond it is the most direct
...
\item \textbf{Multi-market pooling.} US and Indian firms are scored against a
  ...
  disclosure regimes. The ESG--volatility association has the same sign in
  both country subsamples (Table~\ref{tab:ext_robust}), but at $N=\NIndia$
  the Indian estimates are imprecise.
